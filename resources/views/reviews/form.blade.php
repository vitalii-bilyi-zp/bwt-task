...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <h2 class="card-header text-center">{{ __('Leave your review') }}</h2>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('reviews') }}">
                        ...
                        <div class="form-group row">
                            <label for="message" class="col-md-4 col-form-label text-md-right">{{ __('Message') }} <span class="text-danger">*</span></label>
