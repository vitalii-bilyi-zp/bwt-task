            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="surname" class="col-md-4 col-form-label text-md-right">{{ __('Surname') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input id="birth-date" type="text" class="form-control @error('birth_date') is-invalid @enderror" name="birth_date" value="{{ old('birth_date') }}" data-provide="datepicker" data-date-language="ru" placeholder="yyyy-mm-dd" autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-check-inline h-100">
                                    ...
                                    <label class="form-check-label" for="female-radio">{{ __('Female') }}</label>
                                </div>

                                <div class="form-check form-check-inline h-100">
                                    <input id="male-radio" type="radio" class="form-check-input" name="gender" value="male" {{ old('gender') == 'male' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="male-radio">{{ __('Male') }}</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 offset-md-4">
                                <span class="help-block"><span class="text-danger">*</span> Required fields</span>
                            </div>
                        </div>
