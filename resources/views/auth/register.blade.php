                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-check-inline h-100">
                                    <input id="female-radio" type="radio" class="form-check-input" name="gender" value="female" @if(old('gender') == 'female') checked @endif>
                                    <label class="form-check-label" for="female-radio">{{ __('Female') }}</label>
                                </div>

                                <div class="form-check form-check-inline h-100">
                                    <input id="male-radio" type="radio" class="form-check-input" name="gender" value="male" @if(old('gender') == 'male') checked @endif>
